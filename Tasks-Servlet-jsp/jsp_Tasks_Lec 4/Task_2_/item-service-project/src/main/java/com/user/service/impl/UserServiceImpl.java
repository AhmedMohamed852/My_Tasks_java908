...
public class UserServiceImpl implements UserService {
    ...
    public boolean loginWithUserName(UserAcount user) {
    	 Connection connection = null; 
         PreparedStatement statement = null; 
         ...
         try  { 
         		...
         		connection = datasource.getConnection(); 
         		String sql = "SELECT username FROM user_acount WHERE username = ?";
	...
	@Override
	public boolean forgetPassword(UserAcount user) {
